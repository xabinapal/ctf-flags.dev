...
<section class="resources-section">
  ...
  <div id="resources-container" class="resources-container">
    ...
    <div class="resource-category" data-category="{{ category }}">
      <h2 class="category-title">{{ category }}</h2>
      <ul class="resource-list">
        {%- for resource in resources -%}
        <li class="resource-item" data-name="{{ resource.name | downcase }}" data-description="{{ resource.description | downcase }}" data-category="{{ category }}">
